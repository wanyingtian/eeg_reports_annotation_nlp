...
lint:
	$(UV) run ruff check scripts/mistral_interface_followup.py scripts/run_fixed_classification_explanations.py scripts/medgemma_prompt_v2.py scripts/audit_medgemma_v2_evidence.py
