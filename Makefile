...
.PHONY: sync sync-all lint test audit-sample verify ci verify-evaluation-surfaces verify-llm-receipt preload-model smoke-model smoke-classification study-status study-ledger medgemma-readiness medgemma-prepare medgemma-tier-dry-run medgemma-tier-status medgemma-tier-run medgemma-native-authorization-check medgemma-native-prepare medgemma-native-dry-run medgemma-native-launch medgemma-native-finalize medgemma-native-author-bundle evidence-review-build evidence-review-verify evidence-clinical-delivery-build evidence-clinical-delivery-verify evidence-review-compare reference-traceability-run reference-traceability-verify governed-run-eclipse
