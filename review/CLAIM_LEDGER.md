...
| 97.8% explanation traceability | Exact producing artifact, polarity-selection rule, matcher stages/thresholds, embedding revision, and raw numerator/denominator | Denominator resolved exactly: saved learned polarity selects 2,180 units. The public whole-report script replay yields 2,018/2,180 (92.57%); a separately named sentence-level diagnostic yields 2,153/2,180 (98.76%). Neither reproduces 2,132. Keep the submitted numerator gated pending original matcher or author confirmation; do not threshold-fit to the printed result. |
