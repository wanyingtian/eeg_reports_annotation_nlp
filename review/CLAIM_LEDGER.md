...
| Contemporary LLM improvement | Exact model/prompt/grammar receipts, immutable same-case predictions, declared prompt-selection population, complete matrices, paired intervals/tests, and patient grouping where possible | Rendered candidate summaries exist outside Git, but producing sources and prediction surfaces are not yet transferred; any selected-best score is exploratory until the development/evaluation boundary is verified |
